...
public class stock_ventas extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stock_ventas);
    ...
    private void UI(){
        ...
        btn_ing_graba = findViewById(R.id.btn_venta_graba);

        codigo = findViewById(R.id.stockVenta_escaneo);
        descripcion = findViewById(R.id.venta_descripcion);
        cantidad = findViewById(R.id.venta_cantidad);
