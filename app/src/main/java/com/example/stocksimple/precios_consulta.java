...
public class precios_consulta extends AppCompatActivity implements View.OnClickListener {
    ...
    // para ingresar datos
    private EditText codigo, denominacion;
    private TextView descripcion, costo, precio, fecha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.precios_consulta);
    ...
    private void UI(){
        ...
        codigo = findViewById(R.id.precioConsulta_escaneo);
        descripcion = findViewById(R.id.precioConsulta_descripcion);
        costo = findViewById(R.id.precioConsulta_costo);
        precio = findViewById(R.id.precioConsulta_precio);
        fecha = findViewById(R.id.precioConsulta_fecha);
        ...
        fecha.setBackgroundResource(R.drawable.edittext_bg);
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_desc:
                try {
                    ...
                    costo.setText(helper.getCosto(codigo.getText().toString()).get(0));
                    precio.setText(helper.getPrecio(codigo.getText().toString()).get(0));

                    String fechaTxt = helper.getFecha(codigo.getText().toString()).get(0);
                    if (fechaTxt.length()>12) {
                        fechaTxt = fechaTxt.substring(8, 10) + "/" + fechaTxt.substring(5, 7) + "/" + fechaTxt.substring(0, 4);
                    }
